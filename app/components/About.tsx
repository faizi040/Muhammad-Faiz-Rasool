...
export default function About() {
  const skills = [
    ...
    { icon: <Server className="w-8 h-8 text-green-500" />, title: "Backend", description: "Node.js, Express" },
    { icon: <Database className="w-8 h-8 text-purple-500" />, title: "Database", description: "MongoDB (Mongoose), MySQL, Sequelize, Prisma" },
