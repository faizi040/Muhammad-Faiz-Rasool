        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0">
              ...
              applications using MongoDB, Express.js, React, Next.js and Node.js.
            </p>
            <div className="flex justify-center lg:justify-start space-x-4 mb-8">
              <a
                href="https://github.com/faizi040"
                target="_blank"
              ...
              <a
                target="_blank"
                href="https://www.linkedin.com/in/muhammad-faiz-rasool-19a3a4279/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                className="p-3 rounded-full bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 transition-colors duration-300 shadow-lg hover:shadow-xl"
              ...
              <a
                target="_blank"
                href="mailto:rasoolf796@gmail.com"
                className="p-3 rounded-full bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 transition-colors duration-300 shadow-lg hover:shadow-xl"
          ...
          >
            <div className="relative w-72 h-72 md:w-96 md:h-96 mx-auto">
              ...
              <div className="relative w-full h-full rounded-2xl shadow-2xl overflow-hidden">
                <Image
                  src="/profile_pic.jpeg" // Ensure the correct path from "public" folder
                  alt="Subhan Muneer"
